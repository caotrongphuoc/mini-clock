...
| [docs/runtime-signal-processing.md](docs/zw_game_runtime_signal_processing.md) | Runtime signal-processing flow for button input, AK task messages, timers, game-loop ticks, object updates, and Mermaid sequence diagrams. |
| [docs/game-object-sequences.md](docs/zw_game_object_sequence.md) | Runtime sequence diagrams for gameplay objects: Gunner, Bullet, Zombie, Car, Bang, Tombstone, and Border. |
...
<table align="center">
  <tr>
    <td align="center"><img src="resources/images/sequence_object/zw_game_zomwar_sequence.png" alt="basic zomwar game sequence logic" width="720"/></td>
  </tr>
</table>
