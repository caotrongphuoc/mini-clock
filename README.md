...
| :---: | :--- | :--- | :--- |
| <img src="resources/images/bitmap/bitmap_gunner.png" width="80"/> | **Gunner** | Player | The player character, positioned on the left side of the screen. Moves vertically to line up with one of the 5 firing rows and shoots Bullets when the player presses **[Mode]**. |
...
| <img src="resources/images/bitmap/bitmap_zombie.png" width="80"/> | **Zombie** | Enemy | The main enemy. Walks left toward the Border with a slight zigzag motion along the Y axis, and gets faster after every wave. Each Zombie destroyed is worth **10 points**. |
