...
| :---: | :--- | :--- | :--- |
| <img src="resources/images/bitmap/bitmap_gunner.gifgif" width="80"/> | **Gunner** | Player | The player character, positioned on the left side of the screen. Moves vertically to line up with one of the 5 firing rows and shoots Bullets when the player presses **[Mode]**. |
