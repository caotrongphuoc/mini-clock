...
| :---: | :--- | :--- | :--- |
| <img src="resources/images/bitmap/bitmap_gunner.png" width="60"/> | **Gunner** | Player | The player character, positioned on the left side of the screen. Moves vertically to line up with one of the 5 firing rows and shoots Bullets when the player presses **[Mode]**. |
| <img src="resources/images/bitmap/bitmap_bullet.png" width="60"/> | **Bullet** | Projectile | Projectile fired by the Gunner. Flies to the right and destroys any Zombie it touches. |
