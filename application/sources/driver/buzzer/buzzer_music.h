...
#include <stdint.h>
	...
	extern const Tone_TypeDef tones_adventure_theme[];
	extern const Tone_TypeDef tones_space_trip[];
	extern const Tone_TypeDef tones_battle_ready[];
	extern const Tone_TypeDef tones_alarm_classic[];
	extern const Tone_TypeDef tones_alarm_rising[];
	extern const Tone_TypeDef tones_alarm_beep_beep[];
	extern const Tone_TypeDef tones_alarm_morning[];
	extern const Tone_TypeDef tones_alarm_urgent[];
