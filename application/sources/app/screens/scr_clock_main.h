...
#define SCR_CLOCK_MAIN_TIME_X (2)
#define SCR_CLOCK_MAIN_TIME_Y (24)
#define SCR_CLOCK_MAIN_FRAME_X (0)
#define SCR_CLOCK_MAIN_FRAME_Y (8)
#define SCR_CLOCK_MAIN_FRAME_W (64)
#define SCR_CLOCK_MAIN_FRAME_H (48)
#define SCR_CLOCK_MAIN_CAL_X (70)
#define SCR_CLOCK_MAIN_CAL_MONTH_Y (0)
#define SCR_CLOCK_MAIN_CAL_WEEKDAY_Y (10)
#define SCR_CLOCK_MAIN_CAL_DAY_Y (19)
#define SCR_CLOCK_MAIN_CAL_COL_STEP (8)
